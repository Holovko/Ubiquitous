...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    private void notifyWear() {
        ...
        Uri uri = WeatherContract.WeatherEntry.buildWeatherLocationWithDate(location,
        ...
        try{
            ...
            mapRequest.getDataMap().putString("highTemp", highTemp);
            mapRequest.getDataMap().putString("lowTemp", lowTemp);
            mapRequest.getDataMap().putAsset("icon", createAssetFromBitmap(bitmap));
